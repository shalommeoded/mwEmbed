                        ...
                        .then( function ( matchDetails ) {
                            ...
                            for ( var i = 0; i < matchDetails.events.length; i++ ) {
                                ...
                                if ( result.length == 0 ) {
                                    switch ( event.type ) {
                                        case "goal":
                                            var button = $( '<button class="live-highlight-icon">' +
                                                '<img src="../../modules/livelights/assets/img/goal.png"' +
                                        ...
                                        case "yellowcard":
                                            var button = $( '<button class="live-highlight-icon">' +
                                                '<img src="../../modules/livelights/assets/img/yellow.png"' +
                                                ' style="width: inherit; height: inherit;"/></button>' );
                                            var percent = event.minute / currentTime;
                                            if ( percent * 100 === 100 ) {
                                                button.css( 'left', '97%' );
                                        ...
                                        case "redcard":
                                            var button = $( '<button class="live-highlight-icon">' +
                                                '<img src="../../modules/livelights/assets/img/red.png"' +
                                                ' style="width: inherit; height: inherit;"/></button>' );
                                            var percent = event.minute / currentTime;
                                            if ( percent * 100 === 100 ) {
                                                button.css( 'left', '97%' );
                                        ...
                                        case "substitution":
                                            var button = $( '<button class="live-highlight-icon">' +
                                                '<img src="../../modules/livelights/assets/img/subtitute.png"' +
                                                ' style="width: inherit; height: inherit;"/></button>' );
                                            var percent = event.minute / currentTime;
                                            if ( percent * 100 === 100 ) {
                                                button.css( 'left', '97%' );
